...
public class StateMachine implements Runnable
{
	...
	public void run()
	{
		try
		{
			...
			{
				porkyUpSpeed = SmartDashboard.getNumber("Porky Up Speed: ", 0); //TODO maybe fix the defaults
				porkyDownSpeed = SmartDashboard.getNumber("Porky Down Speed: ", 0);
				incrementer = SmartDashboard.getNumber("Incrementer: ", 1);

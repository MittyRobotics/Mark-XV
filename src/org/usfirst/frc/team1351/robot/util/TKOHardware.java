...
public class TKOHardware
{
	...
	protected static WPI_TalonSRX[] driveTalons = new WPI_TalonSRX[Definitions.NUM_DRIVE_TALONS];
	protected static WPI_TalonSRX winchTalons[] = new WPI_TalonSRX[Definitions.NUM_WINCH_TALONS];
	protected static WPI_TalonSRX liftTalons[] = new WPI_TalonSRX[Definitions.NUM_LIFT_TALONS];
	protected static WPI_TalonSRX intakeTalons[] = new WPI_TalonSRX[Definitions.NUM_INTAKE_TALONS];
	...
	protected static PIDController pidControlRight, pidControlLeft;
	protected static DoubleSolenoid shifter, upDown, arm60, arm40, ratchet;
	...
	{
		initObjects();
		//TODO: whatever other stuff you want for temp.
	...
	public static synchronized void initPIDControllers() {
		try {
